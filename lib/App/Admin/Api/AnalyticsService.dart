...
class AnalyticsService {
  ...
  static Future<TotalUsersResponse?> getTotalUsers() async {
    return _fetchData("$baseUrl/totalUsers", (json) => TotalUsersResponse.fromJson(json));
  }

  static Future<FreePaidListingsResponse?> getFreeAndPaidListings() async {
    return _fetchData("$baseUrl/totalNumberOfFreeAndPaidListings", (json) => FreePaidListingsResponse.fromJson(json));
  }

  static Future<TotalEarningsResponse?> getTotalEarnings() async {
    return _fetchData("$baseUrl/adminTotalEarnings", (json) => TotalEarningsResponse.fromJson(json));
  }

  static Future<TotalTransactionsResponse?> getTotalTransactions() async {
    return _fetchData("$baseUrl/totalTransactions", (json) => TotalTransactionsResponse.fromJson(json));
  }

  static Future<TotalListingsResponse?> getTotalListings() async {
    return _fetchData("$baseUrl/totalListings", (json) => TotalListingsResponse.fromJson(json));
  }
