...
class NigerianBanks {
  static const List<NigerianBank> banks = [
    ...
    NigerianBank(name: 'Access Bank (Diamond)', code: '063', slug: 'access-bank-diamond'),
    ...
    NigerianBank(name: 'First Bank of Nigeria', code: '011', slug: 'first-bank'),
    ...
    NigerianBank(name: 'Standard Chartered Bank', code: '068', slug: 'standard-chartered'),
    NigerianBank(name: 'Sterling Bank', code: '232', slug: 'sterling-bank'),
    NigerianBank(name: 'Suntrust Bank', code: '100', slug: 'suntrust-bank'),
    NigerianBank(name: 'Union Bank of Nigeria', code: '032', slug: 'union-bank'),
    ...
    NigerianBank(name: 'Sparkle Microfinance Bank', code: '51310', slug: 'sparkle'),
    ...
    NigerianBank(name: 'Coronation Merchant Bank', code: '559', slug: 'coronation'),
    NigerianBank(name: 'FSDH Merchant Bank', code: '501', slug: 'fsdh'),
    NigerianBank(name: 'Rand Merchant Bank', code: '502', slug: 'rand-merchant'),
  ];
