      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildInfoTile(Icons.location_on, "Business Address", vendor.address),
            _buildInfoTile(Icons.location_city, "City", vendor.city),
            _buildInfoTile(Icons.map, "State", vendor.state),
            _buildInfoTile(Icons.work, "Experience", "${vendor.yearOfExperience} years"),
            _buildInfoTile(Icons.star, "Ratings", "${vendor.totalRatings} (${vendor.rate}/5)"),
            _buildInfoTile(Icons.home_repair_service, "Owner Email", userProfile.email),
            _buildInfoTile(Icons.person, "Owner Phone", userProfile.phoneNumber),
          ],
        ),
      ),
    ...
    child: ElevatedButton.icon(
      onPressed: () {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Hire request sent to ${widget.vendor.businessName}!")),
        );
      },
