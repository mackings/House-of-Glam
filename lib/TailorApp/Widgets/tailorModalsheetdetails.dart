...
void showTailorMaterialDetails(BuildContext context, TailorAssignedMaterial item) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Sample images (carousel if multiple)
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        CustomText(item.user.fullName,
                            fontSize: 15, fontWeight: FontWeight.bold),
                        CustomText(item.user.email,
              ...
              _buildInfoRow(
                  "Material Cost", "₦${formatter.format(item.materialTotalCost)}"),
              _buildInfoRow("Workmanship",
                  "₦${formatter.format(item.workmanshipTotalCost)}"),
              _buildInfoRow("Total", "₦${formatter.format(item.totalCost)}",
              ...
              if (item.comment != null && item.comment!.isNotEmpty) ...[
                ...
                CustomText(item.comment!,
                    fontSize: 14, color: Colors.black87),
              ],
const SizedBox(height: 20),

              CustomButton(title: "Deliver Attire", onPressed: (){}),
