...
class QuotationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayMaterial = hasAcceptedOffer && review.finalMaterialCost != null
        ? review.finalMaterialCost!
        : review.materialTotalCost;
        
    final displayWorkmanship = hasAcceptedOffer && review.finalWorkmanshipCost != null
        ? review.finalWorkmanshipCost!
        : review.workmanshipTotalCost;
    ...
    print('   Display Material: ₦$displayMaterial');
    print('   Display Workmanship: ₦$displayWorkmanship');
      ...
      child: Column(
        ...
        children: [
          ...
          if (hasAcceptedOffer && review.finalTotalCost != null && 
            ...
            //       CustomText(
            //         "Saved: ${CurrencyHelper.formatAmount(review.totalCost - review.finalTotalCost!, currencyCode: currencyCode)}",
            //         fontSize: 10,
...
//     // 🔥 FIX: Use the amounts from review (already updated by backend)
...
//     print('   Accepted Offer ID: ${review.acceptedOfferId ?? 'None'}');
//     print('   Status: ${review.status}');
//     print('   Material Cost: ₦$displayMaterial');
//     print('   Workmanship Cost: ₦$displayWorkmanship');
//     print('   Total Cost: ₦$displayTotal');
//     print('   Amount Paid: ₦${review.amountPaid}');
//     print('   Amount To Pay: ₦$displayAmountToPay');
//     print('   Is Part Payment: $isPartPayment');
//     print('   Is Full Payment: $isFullPayment');
...
//                   const SizedBox(width: 6),
//                   CustomText(
//                     "USD: ${CurrencyHelper.formatAmount(review.totalCostUSD, currencyCode: 'USD')}",
//                     fontSize: 11,
//                     color: Colors.blue.shade900,
//                   ),
//                   const SizedBox(width: 4),
